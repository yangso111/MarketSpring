package com.marketSpring.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.marketSpring.*.service.*.*(..)) or "
			+ "execution(* com.marketSpring.*.dao.*.*(..))")
	...
	@After("execution(* com.marketSpring.*.service.*.*(..)) or "
			+ "execution(* com.marketSpring.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.marketSpring.*.service.*.*(..)) or "
			+ "execution(* com.marketSpring.*.dao.*.*(..))")
