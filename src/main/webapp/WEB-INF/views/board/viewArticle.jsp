			  ...
			  <c:forEach var="item" items="${imageFileList}" varStatus="status" >
				    <tr>
					   ...
					   <td>
					    ...
					    <img src="${contextPath}/imgDownload.do?articleNO=${article.articleNO}&imageFileName=${item.imageFileName}" id="preview"  /><br>
					   </td>   
					  </tr>  
					  <tr>
					    <td>
				...
				<c:when test="${not empty article.imageFileName && article.imageFileName!='null' }">
					<tr>
						...
						<td>
							...
							<img src="${contextPath}/imgDownload.do?articleNO=${article.articleNO}&imageFileName=${article.imageFileName}" id="preview" /><br>
						</td>
					</tr>
					<tr>
						<td></td>
