...
<head>
	...
	<script type="text/javascript">
		function backToList(obj){
		    obj.action="${contextPath}/board/reViewBo/listreViewBoard.do";
			obj.submit();
		}
...
<body>
	...
	<form name="articleForm" method="post" action="${contextPath}/board/reViewBo/addNewreViewBoard.do" enctype="multipart/form-data">
		<table border="0" align="center">
			<tr>
				<td align="right">작성자</td>
				<td colspan=2 align="center">${memberInfo.member_name }</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan=2>
					<textarea name="content" rows="20" cols="100" maxlength="4000" placeholder="이곳에 글을 쓰세요."></textarea>
				</td>
			</tr>
			<tr>
